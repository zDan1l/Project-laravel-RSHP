        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">Tambah Kode Tindakan Terapi Baru</h4>
                </div>
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <form action="{{ route('admin.kodentindakan.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode') is-invalid @enderror" 
                                   ...
                                   placeholder="Contoh: KT001, OP002" required>
                            @error('kode')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_tindakan_terapi') is-invalid @enderror" 
                                      id="deskripsi_tindakan_terapi" name="deskripsi_tindakan_terapi" rows="3" required>{{ old('deskripsi_tindakan_terapi') }}</textarea>

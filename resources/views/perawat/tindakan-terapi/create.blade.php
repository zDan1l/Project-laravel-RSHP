    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">Tambah Tindakan Terapi</h4>
                    <p class="text-muted mb-0">Tambahkan tindakan terapi baru</p>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('perawat.tindakan-terapi.store') }}" method="POST">
                                    @csrf
